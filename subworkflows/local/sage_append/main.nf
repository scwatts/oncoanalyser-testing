...
workflow SAGE_APPEND {
    ...
    ch_inputs_sorted = WorkflowOncoanalyser.groupByMeta(
        ...
        .map { meta,
            ...
            tumor_dna_redux_tsv = tumor_dna_redux_tsv.findAll { it -> it != [] }
    ...
    ch_somatic_out = channel.topic('sage_append_dir').filter { it -> it[0].topic_key == 'somatic' }
    ...
    ch_germline_out = channel.topic('sage_append_dir').filter { it -> it[0].topic_key == 'germline' }
